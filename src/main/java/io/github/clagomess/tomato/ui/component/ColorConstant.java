...
public final class ColorConstant {
    ...
    public static final Color GREEN = new Color(117, 186, 36); // #75BA24
    ...
    public static final Color RED = new Color(255, 85, 85); // #FF5555
    public static final Color YELLOW = new Color(241, 250, 140);
    public static final Color GRAY = new Color(97, 99, 101); // #616365
