...
flatpak-builder --force-clean --repo=repo build-dir io.github.clagomess.Tomato.yml
flatpak build-bundle repo tomato-${GIT_TAG}.flatpak io.github.clagomess.Tomato
